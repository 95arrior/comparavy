...
{
  // 2026-08-13 개정: 종결 형태가 '명사구/전언형' 둘에서 어미 메뉴 5종+전언형 쿼터로 확장(실측 79% 쏠림 수술)
ok(/명사구 컷/.test(TITLE_SHAPE_RULE) && /질문형/.test(TITLE_SHAPE_RULE) && /전언형은 세 편에 한 편/.test(TITLE_SHAPE_RULE), "★모양 규칙에 어미 메뉴+전언형 쿼터가 명시됨");
