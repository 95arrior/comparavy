...
export const guideTypeStandards: Record<GuideLayoutType, string[]> = {
  "how-to": [
    ...
    "Include a realistic result preview concept near the top of the public page, mapped to the output type: AI result, document, email, listing, calendar, carousel, or decision result.",
