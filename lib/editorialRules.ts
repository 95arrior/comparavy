...
export const guideTypeStandards: Record<GuideLayoutType, string[]> = {
  "how-to": [
    ...
    "Include a Mac-style Example transformation preview concept with before input, after output, and why it works near the top of the public page.",
  ...
  "tool-decision": [
    ...
    "Include a Mac-style Example transformation preview concept showing the reader's before input, useful after output, and why the recommendation works.",
...
export const comparavyGoldStandardPrompt = [
  ...
  "Every shortcut must include a Mac-style Example transformation preview concept near the top: clear before input, realistic after output, one short why-it-works explanation, no fake testimonials, no fake user stories, no unsupported performance claims, and mobile-readable preview content.",
