...
export const guideTypeStandards: Record<GuideLayoutType, string[]> = {
  "how-to": [
    ...
    "Include a realistic result preview concept near the top of the public page, mapped to the output type: product_result, visual_content_result, document_result, decision_result, or calendar_result.",
    "Preview concepts must support the public blur-to-focus reveal: soft opacity, blur, scale, and translate before entry; sharp readable final state on entry; reduced-motion users see the final state immediately.",
    "Show one primary generated prompt, where to paste it, and what finished output to expect.",
    "Keep the AI Shortcut brief compact with Input, Output, Time, and Works with labels so the prompt builder stays easy to reach.",
  ...
  "tool-decision": [
    ...
    "Include a realistic result preview concept showing the decision outcome, useful output, and why the recommendation works.",
    "Preview concepts must support the public blur-to-focus reveal: soft opacity, blur, scale, and translate before entry; sharp readable final state on entry; reduced-motion users see the final state immediately.",
    "When prompts are included, the public page should use one primary generated prompt instead of multiple prompt choices.",
    "Keep any AI Shortcut brief compact and secondary to the preview and prompt builder.",
...
export const comparavyGoldStandardPrompt = [
  ...
  "Every shortcut must target a task-first SEO phrase and a secondary AI/prompt-aware phrase without keyword stuffing.",
  ...
  "Every shortcut must include a realistic result preview concept near the top: choose product_result only for actual product/design/UI outputs, visual_content_result for social or visual marketing assets, document_result for text outputs, decision_result for recommendations or comparisons, and calendar_result for schedules or plans; include clear input context when useful, realistic output, one short why-it-works explanation, no fake testimonials, no fake user stories, no unsupported performance claims, mobile-readable preview content, and blur-to-focus reveal support with reduced-motion fallback.",
  "Keep the AI Shortcut brief compact and secondary: Input, Output, Time, and Works with should be easy to scan without pushing the prompt builder too far down.",
