      ...
      messages: [
        {
          ...
          content:
            ...
            "• t = 제목. ★이 키워드들은 '꾸준한 검색 수요(롱테일)' 종족 — 주 싸움터는 홈피드가 아니라 검색결과·AI 브리핑이다. 규칙: ①키워드 핵심어를 제목 앞쪽에 배치(검색 매칭) ②검색 의도를 제목에서 완결(대상·조건·방법·기준이 보이게 — 예: '청년 전세대출 조건과 한도, 신청 순서') ③정체를 숨기는 낚시 후킹 금지 — 검색자는 답을 찾지 궁금증을 사지 않는다. 은은한 신뢰 후킹('놓치기 쉬운', '제대로', '핵심만')까지만(20~30자). 키워드에 없는 사실(지역·숫자·기관)은 지어내지 마.\n" +
