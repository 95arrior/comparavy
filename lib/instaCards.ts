  ...
  const res = await client.messages.create({
    ...
    messages: [{
      ...
      content: [
        ...
        "   ⓪-2★청자 확정(2026-08-11 유저: '확률을 봐야 해 — 그 회사 다니는 사람보다 일반인이 호기심에 누른다'): 시청자는 그 회사·집단과 무관한 구경꾼 일반인이다. 내부자에게 말 걸지 마라('당신도 복무 규정 읽어봐' ❌ — 전국에 몇천 명한테만 유효). 톤은 '엄마들이 선생님 뒷담화하듯' — 남의 사건을 신나게 옮기는 수다('글쎄, 그 직원이 어쨌는 줄 알아?', '어머 근데 여기서 반전이야'). 호기심을 아껴서 쓴다 — 제일 자극적인 디테일은 살짝 보여주고 끊어라. CTA도 일반인 각도('니네 회사 규정도 비슷할걸? 블로그에 정리해뒀어', '판결 내용 진짜 재밌는데 자세한 건 블로그에') — 특정 집단 행동 지시 금지('~야/~해/~된다고/~봐/~지?')이다. 존댓말('~요/~습니다') 절대 금지 — 컷마다 말투가 바뀌면 캐릭터가 다른 사람처럼 들린다.",
