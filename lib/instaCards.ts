  ...
  const res = await client.messages.create({
    ...
    messages: [{
      ...
      content: [
        ...
        "  segments = 4~5개(★6개 미만 엄수). 각 세그 say = 10초 분량(2~3문장, 60~90자). ★대사 규칙(2026-08-11 유저 2차: '어려워서 재미없다, 알기 쉽게 재밌게 — 훅은 통과, 나머지 수정'):",
        "   ①훅의 캐릭터를 끝까지 유지 — 컷 2부터 선생님 말투로 돌아가지 마라. 캐릭터=키워드 자신이니 계속 '나'로 말한다('나를 사려면 현금 3천만이 필요해요', '나 이제 아무나 못 만나거든요').",
        "   ②중학생도 아는 말만 — 전문용어는 일상어로 번역해서 말한다('대용증권 인정 제외' → '주식으로 대신 내는 건 안 쳐줘요', 'T+2일' → '판 돈도 이틀 뒤에야 쳐줘요'). 번역 불가능한 용어는 아예 빼라.",
        "   ③한 컷에 개념 하나 + 콕 박히는 숫자 하나만 — 정보를 쑤셔 넣지 마라. 어려운 세부는 '자세한 건 블로그에'로 미룬다.",
        "   ④재미 장치를 컷마다 1개: 충격 대비('1억 있어도 나 못 사요'), 실감 숫자('나 하루 거래 12조였는데 3조로 쪼그라들었어요'), 가벼운 되물음('빡세죠?', '억울하죠?').",
        "   ⑤마지막 세그 = 행동 지시('지금 계좌에 진짜 현금 얼마 있는지 봐 보세요' + '자세한 계산은 블로그에 정리해 뒀어요').",
