    ...
    properties: {
      ...
      body_html: {
        ...
        description:
          ...
          "★가독성(상위 블로거st, '눈에 쫙 들어오게'): ①맨 위 <blockquote>로 '이 글 요약' 2~3줄 인트로 박스 ②정말 중요한 핵심 문장만 <mark>로 형광펜(소제목당 1~2개, 남발 금지) ③★한 문단 1~2문장으로 아주 짧게(한 문단 한 생각, 벽돌 금지) ④나열·비교·단계·조건은 줄글 말고 <ul>로 한눈에 ⑤마지막에 '핵심 요약'을 <ul>로 ⑥[사진:]을 소제목 직후 등 곳곳에 넣어 텍스트 벽을 깸.",
      },
      faq: {
        type: "array",
