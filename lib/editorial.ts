...
const LINEAGE_STOP = new Set(["2024", "2025", "2026", "2027", "지원금", "정부지원금", "보조금", "혜택", "신청", "기준", "조건", "방법", "제도", "정책", "총정리", "정리", "대상", "기한", "안내", "확대", "신규", "변경", "개편", "현실", "이유", "프로젝트", "프로그램", "서비스", "시스템", "플랫폼", "온라인", "사업", "창업", "계획", "발표"]); // ★4자 범용어 추가(2026-08-14 실측: 보도자료 '창업 프로젝트'에서 영화 '프로젝트 헤일메리' OTT 글감이 증식 — '프로젝트'가 4자라 명사 1개 겹침 규칙을 통과했다)
