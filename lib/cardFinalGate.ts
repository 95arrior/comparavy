...
const B2B_RE = /(기업|법인|스타트업|제조사|공장|수출|바우처)\s?(대상|모집|지원|육성|참여)|기업\s?(최대|지원금|지원사업)|(우수|참여|입주|유망)\s?기업|해외\s?진출|수출\s?(기업|바우처|판로)|판로\s?(개척|지원)|원산지\s?(검증|증명)/; // 2026-07-13 실측 보강: 우수기업 해외진출·원산지검증 변형 통과
