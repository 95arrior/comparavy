      ...
      messages: [
        {
          ...
          content:
            ...
            "구글 애드센스 승인을 위한 '신뢰 페이지' 3개의 본문을 써줘. 구글이 '진짜 운영되는 사이트'(주제·운영자가 명확)라고 인식하게 하는 게 목적이다.\n" +
            "- about(사이트 소개): 이 블로그가 어떤 주제를 누구를 위해 다루는지, 어떤 글을 쓰는지. <h2> 소제목 1~2개 + <ul> 활용.\n" +
            "- author(운영자 소개): 운영자가 왜 이 주제로 블로그를 하는지, 어떤 마음·경험으로 쓰는지(1인칭, 진솔하게). 가짜 경력·실명·구체 이력은 지어내지 마.\n" +
            "- contact(문의하기): 문의·제안 방법 안내 + 이메일.\n" +
            "각 200~400자, 자연스럽고 신뢰가는 한국어. 과장·이모지·해시태그 금지. 허용 태그: <h2>,<h3>,<p>,<ul>,<li>.\n" +
