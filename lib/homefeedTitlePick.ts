    ...
    const res = await client.messages.create({
      ...
      messages: [{
        ...
        content: [
          ...
          "채점 기준(후보마다): ①스크롤 중 3초 안에 멈출까 ②'내 얘기네'로 느껴질까 ③안 누르면 손해 같을까 ④★제목이 건 약속을 본문이 지킬 수 있나 — 본문이 못 지킬 과장은 낚시라 확산이 죽는다(즉시 감점). ⑤★의미 패턴 중복·추상명사 실격(2026-08-17: '먼저 확인·알아야 할·핵심·정리·이유'류가 최근 제목과 2회+ 겹치면 감점, 추상명사로 끝나는데 구체 돈·대상이 없으면 실격) ⑥★주장 방향이 근거와 일치하나(2026-08-14 실측: 내용은 '공급 늘려도 집값이 안 잡힌다'인데 제목이 '왜 안 오를까'로 정반대) — 방향 뒤집힌 제목은 클릭돼도 배신감으로 끝난다, 실격.",
