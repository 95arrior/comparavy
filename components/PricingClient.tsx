    ...
    <ul className="mt-6 space-y-2.5 text-sm text-neutral-600">
      {PLAN_FEATURES[plan].map((f) => (
        <li key={f} className="flex gap-2">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#1D75F7" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="mt-0.5 shrink-0">
      ...
      <div className="grid gap-px overflow-hidden rounded-2xl border border-neutral-200 bg-neutral-200 sm:grid-cols-2">
        ...
        <div className="flex flex-col bg-white p-8">
          <div className="flex items-baseline justify-between">
            ...
            <span className="rounded-lg px-2.5 py-0.5 text-xs font-medium" style={{ background: "#1D75F71a", color: "#1D75F7" }}>가장 인기</span>
          </div>
          <p className="mt-3">
