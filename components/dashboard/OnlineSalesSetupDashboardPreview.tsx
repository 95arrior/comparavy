...
const modules = [
  ...
  },
  {
    ...
    preview:
      "구매 후에는 매장/서비스 소개, 대표 서비스 설명, 사진 설명, FAQ, 리뷰 유도 문구와 기본 정보 점검을 버튼처럼 진행할 수 있어요.",
  },
  {
    slug: "instagram-sns",
    name: "인스타/SNS 홍보 세트",
    ...
    preview:
      "구매 후에는 게시글 주제, 캡션, CTA, 스토리 문구, 해시태그 방향, 주간 업로드 흐름을 차례대로 정리할 수 있어요.",
  },
  {
    slug: "review-replies",
    name: "리뷰 답변 시스템",
    ...
    preview:
      "구매 후에는 좋은 리뷰, 보통 리뷰, 불만 리뷰에 답하는 문구와 재방문 안내 문구, 과장 표현 점검 항목을 확인할 수 있어요.",
  },
  {
    slug: "kakao-dm",
    name: "카카오채널/DM 응대 문구",
  ...
  },
  {
    ...
    preview:
      "구매 후에는 이벤트 제목, 쿠폰 안내문, 기간 안내문, 주의사항, SNS/플레이스용 홍보 문구를 한 흐름으로 정리할 수 있어요.",
  },
  {
    ...
    preview:
      "구매 후에는 Toss Payments 준비, 도메인 구매, GA4, Search Console, Meta Pixel, 네이버 서치어드바이저, SEO 기본 점검을 체크리스트로 확인할 수 있어요.",
  },
  {
    ...
    preview:
      "구매 후에는 Day 1부터 Day 7까지 무엇을 쓰고, 어디에 올리고, 무엇을 점검하고 개선할지 실행 순서를 볼 수 있어요.",
  },
] as const;
