...
export default function BlogSetup({
  ...
  const chip = (on: boolean) =>
    `rounded-xl border px-4 py-3 text-sm font-medium transition ${
      on ? "border-[#1D75F7] bg-[#1D75F7]/5 text-[#2f7fe6]" : "border-neutral-200 text-neutral-600 hover:border-neutral-300"
    }`;
  const inputCls =
    "mt-4 w-full rounded-xl border border-neutral-200 px-4 py-3.5 text-base outline-none transition focus:border-[#1D75F7] focus:ring-2 focus:ring-[#1D75F7]/20";
      ...
      <div key={step} className="ateflo-step-in min-h-[240px]">
          ...
          <div>
            ...
            <div className="mt-6">
              ...
              <select
                ...
                className="mt-3 w-full rounded-xl border border-neutral-200 bg-white px-4 py-3.5 text-base outline-none transition focus:border-[#1D75F7] focus:ring-2 focus:ring-[#1D75F7]/20"
              >
        ...
        {step === 5 && (
          <div>
            ...
            <div className="mt-5 rounded-2xl border border-[#1D75F7]/20 bg-[#1D75F7]/5 p-5">
