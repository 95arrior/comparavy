...
const FEATURES = [
  ...
  { t: "AI 태그 추천", d: "태그, 알아서 추천해요. 쓰던 것도 바로 써요.", d2: "M20.6 13.4 12 22l-9-9V4h9zM7 7h.01" },
  { t: "카테고리 관리", d: "만들고, 고르고, 분류까지 한 번에.", d2: "M3 7h7l2 2h9v9H3z" },
  ...
  return (
    <section className="border-t border-neutral-200/70 bg-neutral-50">
      <div className="mx-auto max-w-5xl px-6 py-24 sm:py-28">
        <Reveal>
          <p className="text-center text-sm font-semibold tracking-tight" style={{ color: BRAND }}>이런 것도 돼요</p>
