...
function StripCard({
  ...
  return (
    <article className="flex min-h-[560px] w-[300px] shrink-0 flex-col rounded-3xl border border-slate-200 bg-white p-5 shadow-sm transition hover:border-teal-200 hover:shadow-md sm:w-[390px] sm:p-6 lg:w-[430px]">
