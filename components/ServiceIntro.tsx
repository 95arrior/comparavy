...
const FEATURES = [
  { title: "껍데기 도구가 아니에요", body: "키워드만 넣으면 글 뱉는 도구는 많죠. 우리는 ‘어떻게 써야 사람이 끝까지 읽는지’를 구조와 프롬프트에 직접 설계했어요." },
  { title: "같은 키워드, 매번 다른 글", body: "같은 키워드로 여러 번 써도 글 구조가 안 겹치게 만들었어요. 복붙한 듯한 양산글이 안 나와요." },
  { title: "없는 얘기는 안 지어내게", body: "가짜 통계·후기·안 해본 경험을 만들지 않도록 규칙을 박아뒀어요. 그대로 올려도 탈 안 나게요." },
  { title: "AI 티를 최대한 뺐어요", body: "‘알아보겠습니다’ 같은 뻔한 말투랑 번역투를 걸러내요. AI 냄새를 최대한 줄였어요." },
  { title: "SEO 기본기는 자동으로", body: "제목·메타·FAQ·소제목을 한국 구글에 맞게 자동으로 챙겨요. 상위 노출은 글과 시간이 만들지만, 출발선은 갖춰드려요." },
  { title: "쓰고 끝이 아니에요", body: "워드프레스에 버튼 하나로 발행까지(프로 플랜). 복사·붙여넣기 하느라 고생할 일 없어요." },
];
