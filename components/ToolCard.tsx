...
export default function ToolCard({ tool }: ToolCardProps) {
  return (
    <article className="flex h-full min-h-[560px] flex-col rounded-3xl border border-slate-200 bg-white p-4 shadow-sm ateflo-card-lift sm:p-5">
      ...
      <div className="mt-4 rounded-2xl border border-slate-100 bg-slate-50/70 p-3.5">
        ...
        <p className="ateflo-clamp-2 mt-2 min-h-12 text-sm leading-6 text-slate-700">
