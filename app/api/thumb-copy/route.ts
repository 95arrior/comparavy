...
export async function POST(request: Request) {
  ...
  const prompt = [
    ...
    "",
    "규칙:",
    "- 6~14자, 구어체, 스크롤을 멈추게 하는 어그로. 단 글이 실제로 답하는 내용과 반드시 연관(낚시 금지).",
    "- 톤 예시(이 감각 그대로): '7월 마감 지원금 실화?' / '이거 신청 안 하면 손해' / '7월 지원금, 지금 신청' / '중기 지원금 놓치지마'",
    "- 서로 다른 각도로: 마감·시의 / 손해 회피 / 즉시 행동 / 짧은 명사형 / 질문형 / 대상 지목 중 6가지.",
